...
class WheelSelectionHandler : public rviz_common::interaction::SelectionHandler
{
private:
  const ssl_vehicle_tracking_msgs::msg::Wheel* object_ = nullptr;
...
public:
  explicit WheelSelectionHandler(rviz_common::DisplayContext* context);
  ...
  const ssl_vehicle_tracking_msgs::msg::Wheel* getObject() const;
  void setObject(const ssl_vehicle_tracking_msgs::msg::Wheel* object);
};
